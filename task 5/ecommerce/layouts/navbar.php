...
// $categoriesStmt = $category->all()->get_result();
// if ($categoriesStmt->num_rows >= 1) {
                                                ...
                                                foreach ($categories as $cat) { ?>
                                                    <li>
                                                        <ul>
                                                            ...
                                                            $subcategoryStmt = $subcategory->getSubCategoryByCategoryId()->get_result();
                                                            if ($subcategoryStmt->num_rows >= 1) {
                                                                foreach ($subcategoryStmt->fetch_all(MYSQLI_ASSOC) as $sub) { ?>
